...
<div class="col-md-12">
    <div class="card">
        <div class="card-header bg-warning">
            <h3 class="card-title"><i class="fa fa-sitemap"></i> {PHP.L.Modules}</h3>
        </div>
        <div class="card-body">
            <div class="row">
                    ...
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-number">
                                <a class="h5" href="{ADMIN_STRUCTURE_EXT_URL}"><strong>{ADMIN_STRUCTURE_EXT_NAME}</strong></a>
                            </span>
                        </div>
                    </div>
                </div>
...
<div class="col-md-12">
    ...
    <div class="card">
        <div class="card-header bg-warning">
            <h3 class="card-title"><i class="fas fa-sitemap"></i> {PHP.L.Structure}</h3>
        </div>  
        <div class="card-body">
