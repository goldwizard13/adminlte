...
<div class="col-md-12">
    ...
    <div class="card">
        <div class="card-header bg-primary">
            <h3 class="card-title"><i class="fas fa-puzzle-piece"></i> {PHP.L.Extcontrol}</h3>
        ...
        <div class="card-body">
            <div class="btn-group flex-wrap m-2">
                <a class="btn <!-- IF {ADMIN_EXTENSIONS_SORT_ALP_SEL} -->btn-success<!-- ELSE -->btn-primary<!-- ENDIF -->" href="{ADMIN_EXTENSIONS_SORT_ALP_URL}"><i class="fas fa-font"></i> <span>{PHP.L.adm_sort_alphabet}</span></a>
                <a class="btn btn-primary  <!-- IF {ADMIN_EXTENSIONS_SORT_CAT_SEL} -->btn-success<!-- ELSE -->btn-primary<!-- ENDIF -->" href="{ADMIN_EXTENSIONS_SORT_CAT_URL}"><i class="fas fa-sitemap"></i> <span>{PHP.L.adm_sort_category}</span></a>
                <a class="btn <!-- IF {ADMIN_EXTENSIONS_ONLY_INSTALLED_SEL} -->btn-success" href="{ADMIN_EXTENSIONS_ONLY_INSTALLED_URL}"<!-- ELSE -->btn-primary" href="{ADMIN_EXTENSIONS_ONLY_INSTALLED_URL}"<!-- ENDIF -->><i class="fas fa-check-square-o"></i> <span>{PHP.L.adm_only_installed}</span></a>
                <a class="btn btn-primary" href="{ADMIN_EXTENSIONS_HOOKS_URL}"><i class="fas fa-code"></i> <span>{PHP.L.Hooks}</span></a>
            </div>
        </div>
    </div>
    <!-- BEGIN: SECTION -->
